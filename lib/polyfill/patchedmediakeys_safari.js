...
shaka.polyfill.PatchedMediaKeysSafari.install = function() {
  ...
  // Alias
  let PatchedMediaKeysSafari = shaka.polyfill.PatchedMediaKeysSafari;
...
shaka.polyfill.PatchedMediaKeysSafari.requestMediaKeySystemAccess =
  ...
  let PatchedMediaKeysSafari = shaka.polyfill.PatchedMediaKeysSafari;
  try {
    let access = new PatchedMediaKeysSafari.MediaKeySystemAccess(
...
shaka.polyfill.PatchedMediaKeysSafari.MediaKeySystemAccess.prototype.
  ...
  let mediaKeys = new PatchedMediaKeysSafari.MediaKeys(this.keySystem);
...
shaka.polyfill.PatchedMediaKeysSafari.MediaKeySession.prototype.
  ...
  let isCertificateRequest = shaka.util.Uint8ArrayUtils.equal(event.message,
      new Uint8Array(shaka.util.StringUtils.toUTF8('certificate')));

  if (isCertificateRequest) {
    let certificate = this.mediaKeys_.serverCertificate;
...
shaka.polyfill.PatchedMediaKeysSafari.MediaKeySession.prototype.
  ...
  let error = new Error('EME PatchedMediaKeysSafari key error');
...
shaka.polyfill.register(shaka.polyfill.PatchedMediaKeysSafari.install);
